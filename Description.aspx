                    ...
                    <div class="card mb-10">
                        ...
                        <div class="card-body store-body">
                            ...
                            <div class="product-payment">
                                <h3><strong>
                                    <asp:Label ID="lblName" runat="server"></asp:Label></strong></h3>
                                Artist:
                                <asp:HyperLink ID="hplArtist" runat="server"></asp:HyperLink>
                                <%--Artist:<a href='ClientArtistProfile.aspx?artistID='><asp:Label ID="lblArtist" runat="server" Text="Label"></asp:Label> </a>--%>

                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"></asp:SqlDataSource>
                                <p style="color: #ce2b2b;"><i>
                                    <asp:Label ID="lblCategory" runat="server"></asp:Label></i></p>
                                <p>Dimensions:  
                                    <asp:Label ID="lblHeight" runat="server"></asp:Label>cm (H) x
                                    <asp:Label ID="lblWidth" runat="server"></asp:Label>cm (W)</p>
                                <br />
                                ...
                                <p style="color: gray;">Published Date:
                                ...
                                <h5 class="product-price display-4" style="font-size: 1.5em;">
                                    <asp:Label ID="lblPrice" runat="server"></asp:Label></h5>
                                <br />
                                <br />
                                <br />
