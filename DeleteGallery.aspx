<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeleteGallery.aspx.cs" Inherits="Ertist.DeleteGallery" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <link href="css/button.css" rel="stylesheet" />

     <div style="padding:5%;">
    <h3>Delete Gallery</h3><br />
               ...
               <tr>
                ...
                <tr>
                    <td class="auto-style3" style="width: 140px">
                        <asp:Button ID="btnCancel" class="art-pg-btn" runat="server" Text="Cancel" />
                    </td>
                    <td>
                        <asp:Button ID="btnDelete" class="art-pg-btn" runat="server"  Text="Delete" />
                    </td>
                </tr>
