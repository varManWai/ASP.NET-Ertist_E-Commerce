...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="cart_section">
        ...
        <div class="cart_all">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ertistDB %>" SelectCommand="SELECT SUM(Artwork.price) AS Expr1, Cart.userID FROM Artwork INNER JOIN [User] ON [User].UserID = 6 INNER JOIN Cart ON Artwork.artworkID = Cart.artworkID AND [User].UserID = Cart.userID GROUP BY Cart.userID"></asp:SqlDataSource>
        </div>
