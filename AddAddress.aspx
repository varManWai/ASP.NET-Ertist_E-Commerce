                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td> <asp:TextBox ID="txtState" runat="server" ></asp:TextBox>
                        ...
                        <asp:RegularExpressionValidator ID="revState" runat="server" ErrorMessage="State must in characters and should not be more than 50 characters " Text="*" ForeColor="Red" ControlToValidate="txtState" ValidationExpression="^[a-zA-Z ]{0,50}$"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                 <tr>
                    <td class="auto-style3" style="width: 140px">&nbsp;</td>
