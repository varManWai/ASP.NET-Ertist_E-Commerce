            ...
            <table class="auto-style5" style="font-size:14px;">
                ...
                <tr>
                    ...
                    <td style="height: 22px">
                        ...
                        <asp:RegularExpressionValidator ID="revName" runat="server" ErrorMessage="Name should not be more than 100 characters " Text="*" ForeColor="Red" ControlToValidate="txtName" ValidationExpression="^[0-9a-zA-Z ]{0,100}$"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3" style="width: 140px">&nbsp;</td>
