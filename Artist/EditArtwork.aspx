...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="padding: 5%;">
        ...
        <br />
        <br />
        <asp:GridView ID="Images" runat="server" AutoGenerateColumns="False" OnRowDataBound="OnRowDataBound" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" Style="width: 100%; text-align: center;" GridLines="Vertical" AllowPaging="True" DataSourceID="SqlEditArtwork">
            ...
            <Columns>
	            ...
	            <asp:BoundField DataField="width" HeaderText="Width (cm)"/>
